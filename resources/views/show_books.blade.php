        ...
        <ul class="row book-info-container">
            ...
            <li class="col-lg-3 col-sm-6 col-md-3 book-info p-2 d-flex flex-column align-items-center">
                ...
                <label class="book-title mb-2 text-center">
                    <a class="text-danger text-decoration-none" href="#">{{ $book->title }}</a>
                </label>
                <span class="buy">
                    <i class="fa fa-inr"></i>
                    {{ $book->price }}
    ...
    <section class="bk-ctg-astrology mt-4 panel">
        ...
        <ul class="row book-info-container">
            ...
            <li class="col-lg-3 col-sm-6 col-md-3 book-info p-2 d-flex flex-column align-items-center">
                ...
                <div class="add-cart mt-2">
                    <button class="cart-button" ><a class='text-decoration-none' href='{{ url('category/'.$category->slug) }}'>View Details</a></button>
                </div>
            </li>
            @endforeach
        </ul>
